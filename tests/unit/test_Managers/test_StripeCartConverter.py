...
def test_StripeCartConverter_convert_dict(test_app):
    '''
...
def test_StripeCartConverter_convert_all_dicts(shopping_order,test_app):
    '''
        `GIVEN` a StripeCartConverter model
...
def test_StripeCartConverter_convert_all_dicts_empty_cart(test_app):
    '''
        `GIVEN` a StripeCartConverter model
